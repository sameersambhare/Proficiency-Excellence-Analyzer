...
public class CollegeHomePage extends JFrame {
    private JPanel contentPane;
    private Image backgroundImage;
    static String username;
    public CollegeHomePage(String username) {
    	CollegeHomePage.username=username;
        setTitle("College Homepage" + username);
        ...
        JLabel welcomeLabel = new JLabel("Welcome to the College Portal");
    ...
    private JPanel createNavBarPanel() {
        ...
        JButton uploadDocumentButton = createButton("Upload Document", UIManager.getIcon("OptionPane.informationIcon")); // Changed button text
        ...
        navBarPanel.add(Box.createRigidArea(new Dimension(10, 0))); // Add space between buttons
        navBarPanel.add(uploadDocumentButton);
        navBarPanel.add(Box.createRigidArea(new Dimension(10, 0))); // Add space between buttons
        ...
        homeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                SwingUtilities.invokeLater(() -> {
                    CollegeHomePage homePage = new CollegeHomePage(username);
        ...
        profileButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    // Create a CollegeProfilePage instance with the current username
                    CollegeProfilePage profilePage = new CollegeProfilePage(username);

                    // Hide the current CollegeHomePage
                    setVisible(false);

                    // Set up a window listener to handle returning to CollegeHomePage
                    profilePage.addWindowListener(new WindowAdapter() {
                        @Override
                        public void windowClosed(WindowEvent e) {
                            // Show the CollegeHomePage again when CollegeProfilePage is closed
                            setVisible(true);
                        }
                    });

                    // Display the CollegeProfilePage
    ...
    private JButton createHelpButton() {
        ...
        helpButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Set up a window listener to handle returning to CollegeHomePage
                contactPage.addWindowListener(new WindowAdapter() {
                    @Override
                    public void windowClosed(WindowEvent e) {
                        // Show the CollegeHomePage again when ContactPage is closed
                        setVisible(true);
                    }
                });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            CollegeHomePage collegeHomePage = new CollegeHomePage(CollegeHomePage.username);
