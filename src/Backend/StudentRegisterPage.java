...
public class StudentRegisterPage extends JFrame {
    ...
    private void registerStudent() {
        ...
        boolean success = DatabaseManager.insertStudentCredentials(username, password);

        if (success) {
            JOptionPane.showMessageDialog(this, "User registered successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            dispose(); // Close the registration page
            SwingUtilities.invokeLater(() -> new StudentHomePage(username).setVisible(true)); // Open the homepage
        } else {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new StudentRegisterPage().setVisible(true));
    }
}
