...
public class HRHomePage extends JFrame {
    private JPanel contentPane;
    private Image backgroundImage;
    String username;

    public HRHomePage(String username) {
    	this.username=username;
        setTitle("HR Homepage");
        ...
        JLabel welcomeLabel = new JLabel("Welcome to the HR Portal");
    ...
    private JPanel createNavBarPanel() {
        ...
        JButton postJobsButton = createButton("Post Jobs", UIManager.getIcon("OptionPane.informationIcon")); // Changed button text
        JButton responseButton = createButton("Response", UIManager.getIcon("OptionPane.informationIcon")); // Changed button text
        ...
        navBarPanel.add(Box.createRigidArea(new Dimension(10, 0))); // Add space between buttons
        navBarPanel.add(postJobsButton);
        navBarPanel.add(Box.createRigidArea(new Dimension(10, 0))); // Add space between buttons
        navBarPanel.add(responseButton);
        navBarPanel.add(Box.createRigidArea(new Dimension(10, 0))); // Add space between buttons
        ...
        homeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Open a new HomePage
                SwingUtilities.invokeLater(() -> {
                    HRHomePage homePage = new HRHomePage(username);
                    homePage.setVisible(true);
                });
            }
        });
        ...
        profileButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                SwingUtilities.invokeLater(() -> {
                    HRAccountPage accountPage = new HRAccountPage(username);
        ...
        postJobsButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Set the desired username here
                SwingUtilities.invokeLater(() -> {
                    PostJobForm jobForm = new  PostJobForm();
