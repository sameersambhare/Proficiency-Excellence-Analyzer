...
public class CollegeRegisterPage extends JFrame {
    ...
    public CollegeRegisterPage() {
        setTitle("College Registration");
        setSize(600, 450);
        ...
        registerButton.addActionListener(e -> registerCollege());
    ...
    private void registerCollege() {
        ...
        boolean success = DatabaseManager.insertClgCredentials(username, password);
        if (success) {
            JOptionPane.showMessageDialog(this, "User registered successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            dispose(); // Close the registration page
            SwingUtilities.invokeLater(() -> new CollegeHomePage(username).setVisible(true)); // Open the homepage
        } else {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new CollegeRegisterPage().setVisible(true));
    }
}
